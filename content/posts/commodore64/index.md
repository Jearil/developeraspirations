...
![Commodore 64](commodore64.avif)

I never had a Commodore 64 growing up, though I was exposed to them. In my Aunt's basement that I was often at as a child, they had one with a few games. At school, we used C64s to learn how to type before DOS and Windows eventually took over. We did have an Intellivision, and later on an NES, Genesis, and eventually a Windows 3.11 PC. However, the Commodore was always a facinating machine to me, with its esoteric commands for loading programs and the `BASIC` prompt that
